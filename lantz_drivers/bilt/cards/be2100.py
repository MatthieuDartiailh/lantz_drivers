...
from lantz_core.has_features import set_feat, subsystem, channel
...
class BE2100(BN100Card, DCVoltageSource):
    ...
    with output as o:
        ...
        with o.trigger as tr:
            ...
            #: - off : immediate update of voltage everytime the voltage
            #:   feature is
            #:   updated.
        ...
        def _limits_voltage(self):
            ...
            """
            rng = float(self.voltage_range)  # Casting handling Quantity
